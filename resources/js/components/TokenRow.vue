<template>
  <tr>
    <td class="py-2 border-t border-gray-100 dark:border-gray-700 px-2 td-fit pl-5 pr-5 dark:bg-gray-800"></td>
    <td class="px-2 py-2 border-t border-gray-100 dark:border-gray-700 whitespace-nowrap dark:bg-gray-800">
    ...
    <td class="px-2 py-2 border-t border-gray-100 dark:border-gray-700 whitespace-nowrap dark:bg-gray-800">
      <div class="text-left text-left" via-resource="users" via-resource-id="1" :title="lastUsedTooltip">
        <span class="whitespace-no-wrap">{{ lastUsed }}</span>
      </div>
    </td>
    <td class="px-2 py-2 border-t border-gray-100 dark:border-gray-700 whitespace-nowrap dark:bg-gray-800">
      <div class="text-left text-left" via-resource="users" via-resource-id="1" :title="expiresTooltip">
        <span class="whitespace-no-wrap">{{ expires }}</span>
      </div>
    </td>
    <td class="py-2 border-t border-gray-100 dark:border-gray-700 px-2 td-fit text-right align-middle dark:bg-gray-800">
      <div class="flex items-center justify-end space-x-0 text-gray-400">
        <button aria-label="Delete" class="toolbar-button hover:text-primary-500 px-2 v-popper--has-tooltip"
    ...
    <DeleteTokenModal :show="showDeleteModal" :token-name="token.name" @cancel="showDeleteModal = false"
